...
use Middag\Moodle\Adapter\Logger;
use Middag\Moodle\Adapter\Translator;
use Middag\Moodle\Adapter\View;
use Middag\Moodle\Contract\TranslatorInterface;
use Middag\Moodle\Contract\ViewAdapterInterface;
use Middag\Moodle\Infrastructure\Bus\MoodleUserContext;
use moodle_database;
use moodle_page;

...
namespace Middag\Moodle\Kernel\Http;
...
use Middag\Moodle\Contract\MoodleControllerInterface as controller_interface;
use Middag\Moodle\Enum\ContextLevel as context_level;
use Middag\Moodle\Infrastructure\Output\Widget;
